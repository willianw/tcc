...
\titulo{Identificação do diagnóstico (CID) de pacientes com base em suas informações hospitalares do SIASUS/SIHSUS}

\autor{\uppercase{Willian Werner Angelo da Costa}}
...
\coorientador{Prof. Dr. Alexandre Dias Porto Chiavegatto Filho}

\tipotrabalho{Trabalho de Conclusão de Curso}

\preambulo{
Versão original \newline \newline \newline 
Projeto apresentado à Escola Politécnica da Universidade de São Paulo para conclusão do curso de graduação em Engenharia de Computação. 
}
% --- Correção
